...
reported results. The full Francisco Odero Alvarez collection is not
redistributed. Cached OCR/VLM text, qrels, rankings, and metrics are provided
...
questions, contact `josemiguel.mota@uca.es` or use GitHub Issues.
